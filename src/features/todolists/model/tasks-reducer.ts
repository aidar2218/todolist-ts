...
export const removeTaskAC = (payload: {todolistID: string, taskID: string}): RemoveTaskActionType => {
    return {type: "REMOVE-TASK", payload} as const;
};

export const addTaskAC = (payload: {todolistID: string, taskTitle: string}): AddTaskActionType => {
